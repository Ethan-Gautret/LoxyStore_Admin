...
class CategoryController extends Controller
{
    ...
    private function upsertTdsynexBatch(string $categoryCode, array $remoteProducts, array &$allSkus, int &$created, int &$updated): void
    {
        ...
        // L'import ramène TOUT le catalogue de la catégorie (aucun filtre ici).
        // Les filtres décident de ce qui est ENVOYÉ à PrestaShop, au moment du push
        // (voir CategorySyncController::performPush).
